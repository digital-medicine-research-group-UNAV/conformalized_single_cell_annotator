...
"""
This module contains functions for calibrating p-values to control the FDR.

- It has been taken from the following repository: https://github.com/msesia/conditional-conformal-pvalues/tree/main

OWNER: Stephen Bates


- If Any of this code is used, please cite the following paper:
